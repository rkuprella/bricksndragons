  ...
  <aside class="flex flex-col flex-1 px-4 py-6 dark:text-gray-100">
    ...
    >
      <li
        ...
        :key="item.id"
        class="relative flex flex-col items-center pb-4"
      >
        <nuxt-link
          :title="item.name"
        ...
        <div
          class="absolute flex gap-1 top-2 right-2 cursor-help"
        ...
        <div class="flex items-center justify-around w-full">
          ...
          <div
            ...
            :class="item.id === animateItem && 'scale-[2]'"
          >
            {{ item.total }}
          </div>
          <button
    ...
    <div v-if="wantedList.length > 0">
      <div class="flex divide-x divide-primary-100/20 dark:divide-gray-700/80">
        <button
    ...
    >
      ...
      >
        ...
        <span>Load bookmarked list</span>
      </button>
    </div>
  </aside>
</template>
